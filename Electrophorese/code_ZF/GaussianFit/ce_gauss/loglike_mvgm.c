...
void loglike_mvgm(double * , double * , double * , double * , int , int , int , int , int , 
				   double * ,
				 ...
				 int nrhs, const mxArray *prhs[] )
{
	...
	int  i , d , N , M = 1 , V = 1 , R = 1, d2 , dim;
	 ...
	 loglike_mvgm(Z , mu , sigma , p , d , M , N , V, R , 
		 logl , 
 ...
 void loglike_mvgm(double *Z , double *mu , double *sigma , double *p , int d , int M , int N , int V , int R , 
	 double *logl ,
