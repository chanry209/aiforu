function varargout = ISEEU_LOGIN(varargin)
% ISEEU_LOGIN MATLAB code for ISEEU_LOGIN.fig
%      ISEEU_LOGIN, by itself, creates a new ISEEU_LOGIN or raises the existing
%      singleton*.
%
%      H = ISEEU_LOGIN returns the handle to a new ISEEU_LOGIN or the handle to
%      the existing singleton*.
%
%      ISEEU_LOGIN('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ISEEU_LOGIN.M with the given input arguments.
%
%      ISEEU_LOGIN('Property','Value',...) creates a new ISEEU_LOGIN or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ISEEU_LOGIN_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ISEEU_LOGIN_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ISEEU_LOGIN

% Last Modified by GUIDE v2.5 24-Jul-2016 08:44:56

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ISEEU_LOGIN_OpeningFcn, ...
                   'gui_OutputFcn',  @ISEEU_LOGIN_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ISEEU_LOGIN is made visible.
function ISEEU_LOGIN_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ISEEU_LOGIN (see VARARGIN)

% Choose default command line output for ISEEU_LOGIN
...
% UIWAIT makes ISEEU_LOGIN wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ISEEU_LOGIN_OutputFcn(hObject, eventdata, handles) 
